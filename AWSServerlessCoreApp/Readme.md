...
Once you have edited your template and code you can use the following command lines to deploy your application from the command line (these examples assume the project name is *AWSServerlessCoreApp*):

Restore dependencies
```
    cd "AWSServerlessCoreApp"
    dotnet restore
```

Execute unit tests
```
    cd "AWSServerlessCoreApp/test/AWSServerlessCoreApp.Tests"
    dotnet test
```

Deploy application
```
    cd "AWSServerlessCoreApp/src/AWSServerlessCoreApp"
